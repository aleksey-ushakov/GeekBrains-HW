...
к примеру время расчета милионного простого числа без этой библиотеке в 2 раза быстрее чем время расчета 10-тысячного
пришлось сильно уменьшить кол-во вычислений (до 100-10000 раз меньше пороги выставлять)
\n2) Массивы Библиотеки numpy в разы экономит использование памяти, хотя при наличии ресурса это не является проблемой и не влияет на скорость работы
